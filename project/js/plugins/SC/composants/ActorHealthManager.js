...
Imported.SCE_ActorHealthManager = true;
...
(() => {
    ...
    class ActorHealthManager {
        ...
        updateBreath() {
            ...
            if (this.isRecoveryBreath() && isCurrentlyBreathing) {
        ...
        isBreathOk() { /* TBD */ return this._breath >= 100; }
    ...
    SimCraft.ActorHealthManager.ActorHealthManager = ActorHealthManager;
    window.ActorHealthManager = ActorHealthManager; // Make it globally available
    
    // --- Enregistrement du plugin ---
    SC._temp = SC._temp || {};
    SC._temp.pluginRegister = {
        name: "SCE_ActorHealthManager",
        version: "1.0.0",
        icon: "🧬",
        author: "SimCraft",
