...
Game_System.prototype.buildMStyles = function() {
	...
	this._mStyles = [
		...
		{windowskin: 'Window2',arrowGraphic: arrow},
	];
};
...
Window_Message.prototype.setDialDimension = function(){
	
	minHeight = this.fittingHeight(2);
	this.calcTextHeight(textState,true);
}
...
Window_Message.prototype.otherMStyleCommands = function() {
	if(DialMainManager._active){
		lines = $gameMessage.allText().split('\n').length;
